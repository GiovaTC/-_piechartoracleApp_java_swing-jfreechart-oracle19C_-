...
-   Gráfico **Pie Chart** usando **JFreeChart**\
-   Porcentajes de ejemplo: **30%, 40%, 30%**\
-   Guarda datos en Oracle 19c (VALUE1, VALUE2, VALUE3, fecha)\
-   Código 100% funcional y listo para usar en **IntelliJ IDEA**
...
## 📌 3. Código completo Java

**Guárdalo como:** `PieChartOracleApp.java`
...
public class PieChartOracleApp extends JFrame {
    ...
    public PieChartOracleApp() {
        setTitle("Gráfico Excel - Porcentajes (Oracle 19c)");
        setSize(750, 600);
        ...
        // Acción: generar gráfico
        btnGenerar.addActionListener(e -> generarGrafico());

        // Acción: guardar en Oracle
    ...
    private void generarGrafico() {
        try {
            ...
            JFreeChart chart = ChartFactory.createPieChart(
                    "Distribución de Porcentajes (Tipo Excel)",
                    dataset,
                    true,
                    true,
                    false
            ...
            JOptionPane.showMessageDialog(this, "Error al generar gráfico: " + ex.getMessage());
        }
    }
...
-   Botón **Guardar en Oracle**\
-   Registro automático en Oracle con la fecha actual

------------------------------------------------------------------------

## ✔️ Valores de ejemplo que se almacenan
...
Giovanny Alejandro Tapiero Cataño & ChatGPT
